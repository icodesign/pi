 ...
 * supplied by the Node SessionManager subclass; headless consumers use this class directly.
 */
...
/**
 * Structural session owner consumed by AgentSession and extension APIs.
 *
 * The concrete Node SessionManager and portable InMemorySessionManager both
 * satisfy this surface; consumers do not need to depend on either class.
 */
export type SessionManagerContract = Pick<
